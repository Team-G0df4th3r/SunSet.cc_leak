...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildcustom(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0, int i = 0);
    // Styles
    ...
    IMGUI_API bool          Tab(const char* label, const bool selected, float x);
	...
	IMGUI_API bool          ColorBar(const char* label, const ImVec2& size = ImVec2(0, 0));
	// ColorBar
	...
	//IMGUI_API bool		    ListBox(const char * label, int * current_item, bool(*items_getter)(void *, int, const char **), void * data, int items_count, int height_in_items, bool custom_selectable);
    IMGUI_API bool          ListBox(const char* label, int* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int height_in_items = -1);
    IMGUI_API bool          ListBoxHeader(const char* label, const ImVec2& size = ImVec2(0, 0)); // use if you want to reimplement ListBox() will custom data or interactions. if the function return true, you can output elements then call ListBoxFooter() afterwards.
    IMGUI_API bool          ListBoxHeader(const char* label, int items_count, int height_in_items = -1); // "
    IMGUI_API void          ListBoxFooter();                                                    // terminate the scrolling region. only call ListBoxFooter() if ListBoxHeader() returned true!

	//IMGUI_API bool          ListBox(const char* label, int* current_item, [](void* data, int idx, const char** out_text)); //const char * label, int * current_item, const char * const items[], int items_count, int height_items
	...
	IMGUI_API bool			OpenPopupContextItem(const char * str_id, ImGuiPopupFlags popup_flags);

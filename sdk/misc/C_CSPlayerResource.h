...
public:
	...
	{
		static auto m_iPing = netvars::get().get_offset(("CCSPlayerResource"), ("m_iPing"));
		return *(int*)((uintptr_t)this + m_iPing + index * sizeof(int));
	}

	int GetKills(int index)
	{
		static auto m_iKills = netvars::get().get_offset(("CCSPlayerResource"), ("m_iKills"));
		return *(int*)((uintptr_t)this + m_iKills + index * sizeof(int));
	}

	int GetAssists(int index)
	{
		static auto m_iAssists = netvars::get().get_offset(("CCSPlayerResource"), ("m_iAssists"));
		return *(int*)((uintptr_t)this + m_iAssists + index * sizeof(int));
	}

	int GetDeaths(int index)
	{
		static auto m_iDeaths = netvars::get().get_offset(("CCSPlayerResource"), ("m_iDeaths"));
		return *(int*)((uintptr_t)this + m_iDeaths + index * sizeof(int));
	}

	bool GetConnected(int index)
	{
		static auto m_bConnected = netvars::get().get_offset(("CCSPlayerResource"), ("m_bConnected"));

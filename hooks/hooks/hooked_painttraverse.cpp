...
########   ########  ###    ####  ########  ##########     ###    ###  ########   ########        
	...
	const char* ascii2 = R"ascii(
________________________________________________
SunSet.CC V2 Free Version
UPDATES:

-Fixed auto kick when you join a vac protected Server
-New logs
_______________________________________________
	...
	if (set_console)
	{
		...
		m_cvar()->ConsoleColorPrintf(Color::LightBlue, ascii2);
	...
	if (!HudZoomPanel)
		if (!strcmp(("HudZoom"), m_panel()->GetName(panel)))
			HudZoomPanel = panel;

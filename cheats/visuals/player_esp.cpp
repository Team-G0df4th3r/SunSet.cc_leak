...
void playeresp::paint_traverse()
{
	...
	static auto FindHudElement = (DWORD(__thiscall*)(void*, const char*))util::FindSignature(("client.dll"), ("55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39 77 28"));
	static auto hud_ptr = *(DWORD**)(util::FindSignature(("client.dll"), ("81 25 ? ? ? ? ? ? ? ? 8B 01")) + 0x2);

...
static attributableitem_t* make_glove(int entry, int serial) noexcept
{
	...
	static auto Fn = util::find_pattern(("client.dll"), ("\x55\x8B\xEC\x83\xE4\xF8\x51\x53\x56\x57\x8B\xF1"), ("xxxxxxxxxxxx"));
...
{
	if (auto iconOverride = iconOverrides[event->GetString(("weapon"))])
